...
function drawSprite(sprite) {
	if (sprite.flight) {
		...
		if (fraction >= 1) sprite.flight = null;else {
			sprite.flight.x = sprite.flight.startX + (sprite.x - sprite.flight.startX) * fraction;
			sprite.flight.y = sprite.flight.startY + (sprite.y - sprite.flight.startY) * fraction;
